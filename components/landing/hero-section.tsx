    ...
    <section className="container mx-auto flex flex-col items-center justify-center px-4 py-32 text-center md:py-48">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-xl text-muted-foreground sm:text-2xl">
          Ditch the messy spreadsheets. Track applications, manage interviews,
          and land your dream job with Workly.
        </p>
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link href="/sign-up">
            <Button
              size="lg"
              className="h-14 px-8 text-lg font-semibold cursor-pointer"
            >
